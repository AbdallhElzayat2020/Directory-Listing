    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('status', function ($package) {
                return view('admin.package.datatable.status', ['package' => $package]);
            })
            ->addColumn('show_at_home', function ($package) {
                return view('admin.package.datatable.show_at_home', ['package' => $package]);
            })
            ->addColumn('action', function ($package) {
                return view('admin.package.datatable.action', ['package' => $package]);
            })
            ->setRowId('id');
    }
