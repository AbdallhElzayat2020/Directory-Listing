    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($amenity) {
                return view('admin.amenity.datatable.action', ['amenity' => $amenity]);
            })
            ->addColumn('status', function ($amenity) {
                return view('admin.amenity.datatable.status', ['amenity' => $amenity]);
            })
            ->addColumn('icon', function ($amenity) {
                return view('admin.amenity.datatable.icon', ['amenity' => $amenity]);
            })
            ->setRowId('id');
    }
