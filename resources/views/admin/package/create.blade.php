                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="number_of_days" class="form-control"
                                                placeholder="e.g. 30" value="{{ old('number_of_days') }}">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="number_of_listings" class="form-control"
                                                placeholder="e.g. 10" value="{{ old('number_of_listings') }}">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="number_of_photos" class="form-control"
                                                placeholder="e.g. 5" value="{{ old('number_of_photos') }}">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="number_of_videos" class="form-control"
                                                placeholder="e.g. 2" value="{{ old('number_of_videos') }}">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="number_of_amenities" class="form-control"
                                                placeholder="e.g. 10" value="{{ old('number_of_amenities') }}">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="number_of_featured_listings" class="form-control"
                                                placeholder="e.g. 3" value="{{ old('number_of_featured_listings') }}">
