...
<!-- JS Libraies -->
<script src="{{asset('assets/admin/assets/modules/simple-weather/jquery.simpleWeather.min.js')}}"></script>
<script src="{{asset('assets/admin/assets/modules/chart.min.js')}}"></script>
<script src="{{asset('assets/admin/assets/modules/jqvmap/dist/jquery.vmap.min.js')}}"></script>
<script src="{{asset('assets/admin/assets/modules/jqvmap/dist/maps/jquery.vmap.world.js')}}"></script>
